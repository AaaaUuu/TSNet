...
root_path = 'C:/Users/Administrator/Desktop/BAM-main/'
data_path = osp.join(root_path, 'C:/Users/Administrator/Desktop/BAM-main/data/base_annotation/')
...
for index in tqdm(range(len(data_list))):
    ...
    image_path, label_path = root_path + image_path[2:], root_path+ label_path[2:]  #
